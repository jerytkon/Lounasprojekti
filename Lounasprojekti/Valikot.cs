...
//";
    ...
    public string appAscii { get; set; } = @"    
     ______                                                               
     ___  / __________  ______________ ________   ______ ________________ 
     __  /  _  __ \  / / /_  __ \  __ `/_  ___/   _  __ `/__  __ \__  __ \
     _  /___/ /_/ / /_/ /_  / / / /_/ /_(__  )    / /_/ /__  /_/ /_  /_/ /
     /_____/\____/\__,_/ /_/ /_/\__,_/ /____/     \__,_/ _  .___/_  .___/ 
                                                         /_/     /_/      
 ";
    ...
    public ConsoleMenu ravintolaSubMenu(string[] args, Kirjautuminen kirjautuminen)
    {
        ...
        var ravintolaSubMenu = new ConsoleMenu(args, level: 2)
            ...
            .Add("Avaa päivän ruokalista selaimessa", () => TietojenNäyttäminen.AvaaRuokalistaUrl())
